...
import { UserSocket } from '../user/user.type';
...
export class GameGateWay implements OnGatewayInit, OnGatewayConnection, OnGatewayDisconnect {
    ...
    @WebSocketServer() // server is instance of Namespace instead of Server because namespace was specified in @WebSocketGateway
